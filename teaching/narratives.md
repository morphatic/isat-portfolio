...
Sometimes these emails asked specific questions about a new feature of my pedagogy that I was trying out. Below is a summary, in no particular order of some common themes that came out of these essays. **These are representative examples culled from
over 1000 pages of students' exit essays and my notes from our interviews.** ([downloadable here](/supporting_materials/evals.md))
...
I finally had to come to the conclusion that while there were a lot of interesting and beneficial facets to CYOG, it was not serving students well, and I needed to come up with something different. The [entire email thread](https://github.com/morphatic/sis-portfolio/raw/master/supporting_materials/misc/2015--Frattaroli--ConversationAboutSkippingClasses.pdf) is worth a read, but in a nutshell, I had a student tell me I was "the most intriguing/interesting professor I've ever had" and then tell me he was not coming to class, ever. He was completely honest about it in his exit essay:
